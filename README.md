...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  a. React is a library that controls updating the UI and is not a framework for manipulating the DOM.

1. Describe component state.
  a. Compoenent state is what's currently painted on the DOM.

1. Describe props.
  a. Props are properties that we pass to a componenent. Properties have key values pairs.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  a. Side effects are functions that invoked after another process has occured. We can sync effects by passing them states to monitor.
